...
# 生成机器下一步行动的指令
def doInstruct(robot_id, plat_id, speed, direction, robot_x, robot_y, target_id, target_x, target_y, task_type, frame,
               task_end_type):
    # 买卖
    ...
    line_speed = 2 if (distance < 1.2) or abs(angle - math.pi / 2) * 100 / math.pi < 2.5 else 6
